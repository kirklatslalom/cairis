...
class Requirement(ObjectValidator.ObjectValidator):
    ...
    def update(self, attr, val):
        if attr == "label":
            ...
            self.theRationale = val
        elif attr == "originator":
            self.theOriginator = val
        elif attr == "fitCriterion":
            self.theFitCriterion = val
        elif attr == "supportingMaterial":
            self.theSupportingMaterial = val
        elif attr == "type":
            self.theType = val
        elif attr == "domain":
            self.theDomain = val
