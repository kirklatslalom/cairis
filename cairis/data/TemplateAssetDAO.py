...
class TemplateAssetDAO(CairisDAO):
    ...
    def from_json(self, request, to_props=False):
        ...
        json_dict["__python_obj__"] = (
            TemplateAsset.__module__ + "." + TemplateAsset.__name__
        )
    ...
    def simplify(self, ta):
        ...
        ta.theProperties = self.convert_props(
            real_props=ta.theProperties, fake_props=None, rationales=ta.theRationale
        )
        del ta.theRationale
        return ta
