    ...
    def endElement(self, name):
        if name == "entry":
            self.theNamingConventions.append(
                {
                    "name": unescape(self.theCurrentNameEntry),
                    "value": unescape(self.theDefinition),
                }
            )
        elif name == "revision":
            self.theRevisions.append(
                (
                    self.theCurrentRevNo,
                    unescape(self.theCurrentRevDate),
                    unescape(self.theRemarks),
                )
            )
        elif name == "project_settings":
            self.theProjectSettings = (
            ...
            nv = ValueTypeParameters(
                "None",
                unescape(self.theNoneValue),
                "asset_value",
                unescape(self.theName),
            )
            nv.setId(0)
            ...
            lv = ValueTypeParameters(
                "Low", unescape(self.theLowValue), "asset_value", unescape(self.theName)
            )
            lv.setId(1)
            self.theAssetValues.append(lv)

            mv = ValueTypeParameters(
                "Medium",
                unescape(self.theMedValue),
                "asset_value",
                unescape(self.theName),
            )
            mv.setId(2)
            ...
            hv = ValueTypeParameters(
                "High",
                unescape(self.theHighValue),
                "asset_value",
                unescape(self.theName),
            )
            hv.setId(3)
