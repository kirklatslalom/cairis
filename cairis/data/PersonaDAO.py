...
from cairis.tools.ModelDefinitions import (
    PersonaModel,
    PersonaEnvironmentPropertiesModel,
)
...
class PersonaDAO(CairisDAO):
    ...
    def get_persona_model(
        self, persona_name, variable_name, characteristic_name, pathValues=[]
    ):
        ...
        try:
            ...
            associations = AssumptionPersonaModel(
                modelAssocs, font_name=fontName, font_size=fontSize
            )
    ...
    def get_persona_characteristics(
        self, persona_name, variable_name, characteristic_name, pathValue=[]
    ):
        fontName, fontSize, apFontName = get_fonts(session_id=self.session_id)
        if variable_name == "All" or variable_name == "all":
            variable_name = ""
