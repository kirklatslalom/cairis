...
class TaskDAO(CairisDAO):
    ...
    def get_task_model(
        self, environment_name, task_name, misusecase_name, pathValues=[]
    ):
        ...
        try:
            ...
            associationDirectory = self.db_proxy.taskModel(
                environment_name, filter_name, mcFilter
            )
            associations = KaosModel(
                list(associationDirectory.values()),
                environment_name,
                kaosModelType="task",
    ...
    def task_score_by_name_environment(
        self, task_name, environment_name, pathValues=[]
    ):
        try:
    ...
    def task_hindrance_by_name_environment(
        self, task_name, environment_name, pathValues=[]
    ):
        try:
            taskId = self.db_proxy.getDimensionId(task_name, "task")
    ...
    def get_misusability_model(self, mc_name, tc_name, pathValues=[]):
        ...
        try:
            ...
            model = GraphicalAssumptionTaskModel(
                associations,
                db_proxy=self.db_proxy,
                font_name=fontName,
                font_size=fontSize,
