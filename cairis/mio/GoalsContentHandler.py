...
class GoalsContentHandler(ContentHandler, EntityResolver):
    ...
    def startElement(self, name, attrs):
        ...
        if name == "domainproperty":
            ...
            self.thePolicy = {
                "theGoalName": self.theName,
                "theEnvironmentName": self.theEnvironmentName,
                "theSubject": attrs["subject"],
                "theAccessType": attrs["access"],
                "theResource": attrs["resource"],
                "thePermission": attrs["permission"],
            }
    ...
    def endElement(self, name):
        if name == "domainproperty":
            ...
            p = ObstacleEnvironmentProperties(
                self.theEnvironmentName,
                "",
                unescape(self.theDefinition),
                self.theCategory,
            ...
            p = UseCaseEnvironmentProperties(
                self.theEnvironmentName,
                unescape(self.thePreconditions),
                self.theSteps,
                unescape(self.thePostconditions),
            )
            self.theEnvironmentProperties.append(p)
            self.resetUseCaseEnvironmentAttributes()
        elif name == "usecase":
