...
class RequirementTest(unittest.TestCase):
    ...
    def testRequirement(self):
        ...
        ireq = cairis.core.RequirementFactory.build(
            ...
            self.irequirements[0]["theReference"],
            self.irequirements[0]["theReferenceType"],
            1,
        )
        ...
        self.assertEqual(
            self.iassets[0]["theShortCode"] + "-" + str(ireq.label()), str(oreq.label())
        )
