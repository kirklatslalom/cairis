...
from cairis.cairis.core.ARM import ARMException, DatabaseProxyException, UnknownNodeType
...
class ControlStructure:
    def __init__(
        self, associations, envName, db_proxy=None, font_name=None, font_size=None
    ):
            ...
            for (
                ...
                if (fromName, toName) not in edgeSet:
                    ...
                    df = pydot.Edge(
                        ...
                        label=dfName,
                        arrowhead="vee",
                        color=edgeColour(dfType),
                        fontname=self.fontName,
                        fontsize=self.fontSize,
                        fontcolor=edgeColour(dfType),
                        URL=objtUrl,
                    )
