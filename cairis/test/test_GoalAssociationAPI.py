...
class GoalAssociationAPITests(CairisDaemonTestCase):
    ...
    def setUp(self):
        ...
        self.new_assoc_dict = {"session_id": "test", "object": self.new_assoc}
    ...
    def test_get_all(self):
        ...
        url = (
            "/api/goals/association?environment_name=Core%20Technology&session_id=test"
        )
        self.logger.info("[%s] URL: %s", method, url)
        rv = self.app.get(url)
        self.assertIsNotNone(rv.data, "No response")
