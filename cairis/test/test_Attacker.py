    ...
    def testAttacker(self):
        iatkeps = [
            AttackerEnvironmentProperties(
                ...
                self.iAttackers[0]["theEnvironmentProperties"][0]["theMotives"],
                self.iAttackers[0]["theEnvironmentProperties"][0]["theCapabilities"],
            ),
            AttackerEnvironmentProperties(
                self.iAttackers[0]["theEnvironmentProperties"][1]["theName"],
                self.iAttackers[0]["theEnvironmentProperties"][1]["theRoles"],
                self.iAttackers[0]["theEnvironmentProperties"][1]["theMotives"],
                self.iAttackers[0]["theEnvironmentProperties"][1]["theCapabilities"],
            ),
        ]
        iatk = AttackerParameters(
            self.iAttackers[0]["theName"],
        ...
        self.assertEqual(
            str(iatkeps[0].capabilities()[0][0]), str(oatkeps[0].capabilities()[0][0])
        )
        self.assertEqual(
            str(iatkeps[0].capabilities()[0][1]), str(oatkeps[0].capabilities()[0][1])
        )
        self.assertEqual(iatkeps[0].capabilities()[0][0], o.capability("Day", "")[0][0])
        self.assertEqual(
            iatkeps[0].capabilities()[0][0], list(o.capability("", "Maximise"))[0][0]
        )
