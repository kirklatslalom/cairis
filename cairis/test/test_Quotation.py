...
class QuotationTest(unittest.TestCase):
    ...
    def testAddUpdateQuotation(self):
        i1 = (
            self.iQs[0]["theType"],
            self.iQs[0]["theCode"],
            self.iQs[0]["theArtifactType"],
            self.iQs[0]["theArtifactName"],
            self.iQs[0]["theEnvironment"],
            self.iQs[0]["theSection"],
            self.iQs[0]["theStartIdx"],
            self.iQs[0]["theEndIdx"],
            self.iQs[0]["theLabel"],
            self.iQs[0]["theSynopsis"],
        )
        i2 = (
            self.iQs[1]["theType"],
            self.iQs[1]["theCode"],
            self.iQs[1]["theArtifactType"],
            self.iQs[1]["theArtifactName"],
            self.iQs[1]["theEnvironment"],
            self.iQs[1]["theSection"],
            self.iQs[1]["theStartIdx"],
            self.iQs[1]["theEndIdx"],
            self.iQs[1]["theLabel"],
            self.iQs[1]["theSynopsis"],
        )
        b = Borg()
