    ...
    def endElement(self, name):
        if name == "component":
            ...
            p = TemplateAssetParameters(
                ...
                self.theAssetType,
                unescape(self.theSurfaceType),
                unescape(self.theAccessRight),
                spValues,
                srValues,
                self.theTags,
                self.theInterfaces,
            ...
            self.theStructure.append(
                (
                    unescape(self.theHeadName),
                    unescape(self.theHeadAdornment),
                    unescape(self.theHeadNav),
                    unescape(self.theHeadNry),
                    unescape(self.theHeadRole),
                    unescape(self.theTailRole),
                    unescape(self.theTailNry),
                    unescape(self.theTailNav),
                    unescape(self.theTailAdornment),
                    unescape(self.theTailName),
                )
            )
            self.resetStructure()
        elif name == "requirement":
            p = TemplateRequirementParameters(
                unescape(self.theReqName),
                unescape(self.theAsset),
                unescape(self.theType),
                unescape(self.theDescription),
                unescape(self.theRationale),
            ...
            p = ConnectorParameters(
                unescape(self.theName),
                unescape(self.theViewName),
                unescape(self.theFromName),
                unescape(self.theFromRole),
                unescape(self.theFromInterface),
                unescape(self.theToName),
                unescape(self.theToInterface),
                unescape(self.theToRole),
                unescape(self.theConnectorAsset),
                unescape(self.theProtocolName),
                unescape(self.theAccessRight),
            )
            ...
            self.theComponentGoalAssociations.append(
                (
                    unescape(self.theGoalName),
                    unescape(self.theSubGoalName),
                    self.theRefType,
                    unescape(self.theRationale),
                )
            )
