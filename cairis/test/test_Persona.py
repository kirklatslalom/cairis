...
class PersonaTest(unittest.TestCase):
    ...
    def testPersona(self):
        ipp = PersonaParameters(
            self.iPersonas[0]["theName"],
            self.iPersonas[0]["theActivities"],
            self.iPersonas[0]["theAttitudes"],
            self.iPersonas[0]["theAptitudes"],
            self.iPersonas[0]["theMotivations"],
            self.iPersonas[0]["theSkills"],
            self.iPersonas[0]["theIntrinsic"],
            self.iPersonas[0]["theContextual"],
            "",
            "0",
            ...
            [
                PersonaEnvironmentProperties(
                    self.iPersonas[0]["theEnvironmentProperties"][0]["theName"],
                    (
        ...
        self.assertEqual(
            self.iExternalDocuments[0]["theDescription"], oec1.description()
        )
        ...
        self.assertEqual(
            self.iExternalDocuments[1]["theDescription"], oec2.description()
        )
        ...
        self.assertEqual(
            self.iDocumentReferences[0]["theContributor"], odr1.contributor()
        )
        ...
        self.assertEqual(
            self.iDocumentReferences[1]["theContributor"], odr2.contributor()
        )
        ...
        self.assertEqual(
            self.iDocumentReferences[2]["theContributor"], odr3.contributor()
        )
        ...
        self.assertEqual(
            self.iPersonaCharacteristics[0]["thePersonaName"], opc1.persona()
        )
        self.assertEqual(
            self.iPersonaCharacteristics[0]["theModQual"], opc1.qualifier()
        )
        self.assertEqual(
            self.iPersonaCharacteristics[0]["theVariable"], opc1.behaviouralVariable()
        )
        self.assertEqual(
            self.iPersonaCharacteristics[0]["theCharacteristic"], opc1.characteristic()
        )
        self.assertEqual(
            self.iPersonaCharacteristics[0]["ground"], opc1.grounds()[0][0]
        )
        self.assertEqual(
            self.iPersonaCharacteristics[0]["warrant"], opc1.warrant()[0][0]
        )
        self.assertEqual(
            self.iPersonaCharacteristics[0]["rebuttal"], opc1.rebuttal()[0][0]
        )
