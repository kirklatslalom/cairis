...
class AssetModel(object):
    resource_fields = {
        ...
        "theEnvironmentProperties": fields.List(
            fields.Nested(AssetEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class CapabilityModel(object):
    resource_fields = {"name": fields.String, "value": fields.String}
    required = list(resource_fields.keys())
...
class AttackerModel(object):
    resource_fields = {
        ...
        "theTags": fields.List(fields.String),
        "theEnvironmentProperties": fields.List(
            fields.Nested(AttackerEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class CExportParams(object):
    resource_fields = {"theModel": fields.String}
    required = list(resource_fields.keys())
...
class EnvironmentModel(object):
    resource_fields = {
        ...
        "theTensions": fields.List(
            fields.Nested(EnvironmentTensionModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class GoalEnvironmentPropertiesModel(object):
    resource_fields = {
        ...
        "theConcernAssociations": fields.List(
            fields.Nested(ConcernAssociationModel.resource_fields)
        ),
        "theConcerns": fields.List(fields.String),
        "theDefinition": fields.String,
        "theEnvironmentName": fields.String,
        "theFitCriterion": fields.String,
        "theGoalRefinements": fields.List(
            fields.Nested(RefinementModel.resource_fields)
        ),
        "theIssue": fields.String,
        "thePriority": fields.String,
        "theSubGoalRefinements": fields.List(
            fields.Nested(RefinementModel.resource_fields)
        ),
...
class GoalModel(object):
    resource_fields = {
        obj_id_field: fields.String,
        "theEnvironmentProperties": fields.List(
            fields.Nested(GoalEnvironmentPropertiesModel.resource_fields)
        ),
        "theName": fields.String,
        "theOriginator": fields.String,
        "theTags": fields.List(fields.String),
...
class ObstacleModel(object):
    resource_fields = {
        ...
        "theOriginator": fields.String,
        "theEnvironmentProperties": fields.List(
            fields.Nested(ObstacleEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class MisuseCaseModel(object):
    resource_fields = {
        ...
        "theEnvironmentProperties": fields.List(
            fields.Nested(MisuseCaseEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class ResponseEnvironmentPropertiesModel(object):
    resource_fields = {
        "accept": fields.List(
            fields.Nested(AcceptEnvironmentPropertiesModel.resource_fields)
        ),
        "mitigate": fields.List(
            fields.Nested(MitigateEnvironmentPropertiesModel.resource_fields)
        ),
        "transfer": fields.List(
            fields.Nested(TransferEnvironmentPropertiesModel.resource_fields)
        ),
    }
...
class ResponseModel(object):
    resource_fields = {
        ...
        "theName": fields.String,
        "theEnvironmentProperties": fields.Nested(
            ResponseEnvironmentPropertiesModel.resource_fields
        ),
...
class ThreatModel(object):
    resource_fields = {
        ...
        "theEnvironmentProperties": fields.List(
            fields.Nested(ThreatEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class VulnerabilityModel(object):
    resource_fields = {
        ...
        "theDescription": fields.String,
        "theEnvironmentProperties": fields.List(
            fields.Nested(VulnerabilityEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class CountermeasureModel(object):
    resource_fields = {
        ...
        "theType": fields.String,
        "theEnvironmentProperties": fields.List(
            fields.Nested(CountermeasureEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class PersonaModel(object):
    resource_fields = {
        ...
        "theEnvironmentProperties": fields.List(
            fields.Nested(PersonaEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class TaskEnvironmentPropertiesModel(object):
    resource_fields = {
        obj_id_field: fields.String,
        "thePersonas": fields.List(
            fields.Nested(PersonaTaskCharacteristics.resource_fields)
        ),
        "theAssets": fields.List(fields.String),
...
class TaskModel(object):
    resource_fields = {
        ...
        "theTags": fields.List(fields.String),
        "theEnvironmentProperties": fields.List(
            fields.Nested(TaskEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class UseCaseContributionModel(object):
    resource_fields = {
        ...
        "theReferenceContribution": fields.Nested(
            CharacteristicReferenceContribution.resource_fields
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
    ...
    def __getitem__(self, varName):
        if varName == "theContributionTo":
            return self.theContributionTo
        elif varName == "theReferenceContribution":
            return self.theReferenceContribution
        else:
            return None
...
class UseCaseModel(object):
    resource_fields = {
        ...
        "theDescription": fields.String,
        "theReferenceContributions": fields.List(
            fields.Nested(UseCaseContributionModel.resource_fields)
        ),
        "theEnvironmentProperties": fields.List(
            fields.Nested(UseCaseEnvironmentPropertiesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class FindModel(object):
    resource_fields = {
        obj_id_field: fields.String,
        "theSearchValues": fields.List(
            fields.Nested(SearchValuesModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class VersionModel(object):
    resource_fields = {obj_id_field: fields.String, "theVersion": fields.String}
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class PersonaCharacteristicModel(object):
    resource_fields = {
        ...
        "theName": fields.String,
        "theCharacteristicSynopsis": fields.Nested(
            CharacteristicReferenceSynopsis.resource_fields
        ),
        "theGrounds": fields.List(
            fields.Nested(CharacteristicReference.resource_fields)
        ),
        "theWarrant": fields.List(
            fields.Nested(CharacteristicReference.resource_fields)
        ),
        "theRebuttal": fields.List(
            fields.Nested(CharacteristicReference.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
...
class ComponentModel(object):
    resource_fields = {
        ...
        "theDescription": fields.String,
        "theInterfaces": fields.List(fields.Nested(InterfaceModel.resource_fields)),
        "theStructure": fields.List(
            fields.Nested(ComponentStructureModel.resource_fields)
        ),
        "theRequirements": fields.List(fields.String),
        "theGoals": fields.List(fields.String),
        "theGoalAssociations": fields.List(
            fields.Nested(ComponentGoalAssociationModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class SummaryModel(object):
    resource_fields = {"theLabel": fields.String, "theValue": fields.String}
    required = list(resource_fields.keys())
...
class WeaknessAnalysisModel(object):
    resource_fields = {
        obj_id_field: fields.String,
        "theVulnerabilityWeaknesses": fields.List(
            fields.Nested(WeaknessTargetModel.resource_fields)
        ),
        "theThreatWeaknesses": fields.List(
            fields.Nested(WeaknessTargetModel.resource_fields)
        ),
        "thePersonaImpact": fields.List(
            fields.Nested(PersonaImpactModel.resource_fields)
        ),
        "theCandidateGoals": fields.List(
            fields.Nested(CandidateGoalObstacleModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class SecurityPatternModel(object):
    resource_fields = {
        ...
        "theRequirements": fields.List(
            fields.Nested(PatternRequirementModel.resource_fields)
        ),
        "theConcernAssociations": fields.List(
            fields.Nested(SecurityPatternStructureModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class TrustBoundaryEnvironmentModel(object):
    resource_fields = {
        obj_id_field: fields.String,
        "theEnvironmentName": fields.String,
        "theComponents": fields.List(
            fields.Nested(TrustBoundaryComponent.resource_fields)
        ),
        "thePrivilege": fields.String,
    }
    required = list(resource_fields.keys())
...
class TrustBoundaryModel(object):
    resource_fields = {
        ...
        "theDescription": fields.String,
        "theEnvironmentProperties": fields.List(
            fields.Nested(TrustBoundaryEnvironmentModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class ThreatModelElementModel(object):
    resource_fields = {
        ...
        "theProperties": fields.List(
            fields.Nested(ThreatModelPropertyModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
    required.remove(obj_id_field)
...
class ThreatModelModel(object):
    resource_fields = {
        obj_id_field: fields.String,
        "theEntities": fields.List(
            fields.Nested(ThreatModelElementModel.resource_fields)
        ),
        "theProcesses": fields.List(
            fields.Nested(ThreatModelElementModel.resource_fields)
        ),
        "theDatastores": fields.List(
            fields.Nested(ThreatModelElementModel.resource_fields)
        ),
        "theDataflows": fields.List(
            fields.Nested(ThreatModelElementModel.resource_fields)
        ),
    }
    required = list(resource_fields.keys())
