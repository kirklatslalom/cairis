...
class ImpliedCharacteristicTest(unittest.TestCase):
    def setUp(self):
        ...
        i = (
            iQs[0]["theType"],
            iQs[0]["theCode"],
            iQs[0]["theArtifactType"],
            iQs[0]["theArtifactName"],
            iQs[0]["theEnvironment"],
            iQs[0]["theSection"],
            iQs[0]["theStartIdx"],
            iQs[0]["theEndIdx"],
            iQs[0]["theLabel"],
        ...
        i = (
            iQs[2]["theType"],
            iQs[2]["theCode"],
            iQs[2]["theArtifactType"],
            iQs[2]["theArtifactName"],
            iQs[2]["theEnvironment"],
            iQs[2]["theSection"],
            iQs[2]["theStartIdx"],
            iQs[2]["theEndIdx"],
            iQs[2]["theLabel"],
        ...
        b.dbProxy.addCodeRelationship(
            self.iCN[0]["thePersonaName"],
    ...
    def testAddUpdateImpliedCharacteristic(self):
        ...
        p = ImpliedCharacteristicParameters(
            ...
            self.iCN[0]["theToCode"],
            self.iCN[0]["theRshipType"],
            self.iCN[0]["theImpliedCharacteristic"]["theName"],
            self.iCN[0]["theImpliedCharacteristic"]["theQualifier"],
            [
                (
                    self.iCN[0]["theImpliedCharacteristic"]["theFromLabel"],
                    self.iCN[0]["theImpliedCharacteristic"]["theFromReferenceType"],
                )
            ],
            [
                (
                    self.iCN[0]["theImpliedCharacteristic"]["theToLabel"],
                    self.iCN[0]["theImpliedCharacteristic"]["theToReferenceType"],
                )
            ],
            self.iCN[0]["theImpliedCharacteristic"]["theType"],
        )
        b.dbProxy.addImpliedCharacteristic(p)
        b.dbProxy.addIntention(
            (
                self.iCN[0]["theImpliedCharacteristic"]["theName"],
                "implied_characteristic",
                self.iCN[0]["theImpliedCharacteristic"]["theIntentionName"],
                self.iCN[0]["theImpliedCharacteristic"]["theIntentionType"],
            )
        )
        ...
        o = b.dbProxy.impliedCharacteristic(
            self.iCN[0]["thePersonaName"],
            self.iCN[0]["theFromCode"],
            self.iCN[0]["theToCode"],
            self.iCN[0]["theRshipType"],
