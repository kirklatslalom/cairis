...
def threatLikelihoodColourCode(tlValue):
    ...
    if tlValue == "Incredible":
        return "#fef0d9"
    elif tlValue == "Improbable":
        return "#fdcc8a"
    elif tlValue == "Remote":
        return "#fc8d59"
    elif tlValue == "Occasional":
        return "#e34a33"
    else:
        return "#b30000"
...
def vulnerabilitySeverityColourCode(vsValue):
    ...
    if vsValue == "Negligible":
        return "1"
    elif vsValue == "Marginal":
        return "2"
    elif vsValue == "Critical":
        return "3"
    else:
        return "4"
...
def goalSatisfactionColourCode(valueId):
    if valueId >= 50:
        return "5"
    elif valueId > 0 and valueId < 50:
        return "4"
    elif valueId == 0:
        return "3"
    elif valueId >= -50 and valueId < 0:
        return "2"
    elif valueId < -50:
        return "1"
