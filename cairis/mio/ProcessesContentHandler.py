...
class ProcessesContentHandler(ContentHandler, EntityResolver):
    ...
    def endElement(self, name):
        if name == "internal_document":
            p = InternalDocumentParameters(
                self.theName, self.theDescription, self.theContent, [], []
            )
