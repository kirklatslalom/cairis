...
class UsabilityContentHandler(ContentHandler, EntityResolver):
    ...
    def startElement(self, name, attrs):
        ...
        if name == "persona":
            ...
            self.theTaskPersonas.append(
                (
                    attrs["persona"],
                    durationValue(attrs["duration"]),
                    frequencyValue(attrs["frequency"]),
                    attrs["demands"],
                    attrs["goal_conflict"],
                )
            )
    ...
    def endElement(self, name):
        if name == "persona":
            p = PersonaParameters(
                self.theName,
                unescape(self.theActivities),
                unescape(self.theAttitudes),
                unescape(self.theAptitudes),
                unescape(self.theMotivations),
                unescape(self.theSkills),
                unescape(self.theIntrinsic),
                unescape(self.theContextual),
                self.theImage,
                self.isAssumptionPersona,
                self.theType,
                self.theTags,
                self.theEnvironmentProperties,
                {},
            ...
            p = PersonaEnvironmentProperties(
                self.theEnvironmentName,
                self.isDirect,
            ...
            p = DocumentReferenceParameters(
                self.theName,
                self.theDocument,
                self.theContributor,
                unescape(self.theExcerpt),
            )
            ...
            p = TaskParameters(
                ...
                unescape(self.theCode),
                unescape(self.theObjective),
                self.isAssumptionTask,
                self.theAuthor,
                self.theTags,
                self.theEnvironmentProperties,
            )
            ...
            p = TaskEnvironmentProperties(
                unescape(self.theEnvironmentName),
                unescape(self.theDependencies),
                self.theTaskPersonas,
                self.theConcerns,
                self.theConcernAssociations,
                unescape(self.theNarrative),
                ...
                [],
                {"narrative": {}, "consequences": {}, "benefits": {}},
            )
            self.theEnvironmentProperties.append(p)
            self.resetTaskEnvironmentAttributes()
        elif name == "activities":
