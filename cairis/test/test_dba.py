...
class DBATest(unittest.TestCase):
    ...
    def testCreateShareResetDelete(self):
        ...
        createDatabaseSchema(
            b.cairisRoot, b.dbHost, b.dbPort, testAccount, rp, dbAccount + "_default"
        )

        with app.app_context():
            user_datastore.create_user(
                email=testAccount, account=dbAccount, password="test", name="Test user"
            )
            db.session.commit()
        ...
        createDatabaseSchema(
            b.cairisRoot, b.dbHost, b.dbPort, testAccount, rp, dbAccount + "_Test1"
        )
        ...
        createDatabaseAccount(
            b.rPasswd, b.dbHost, b.dbPort, testAccount2, dbAccount2, rp2
        )
        createDatabaseAndPrivileges(
            b.rPasswd,
            b.dbHost,
        ...
        createDatabaseSchema(
            b.cairisRoot, b.dbHost, b.dbPort, testAccount, rp2, dbAccount2 + "_default"
        )
