...
class GoalEnvironmentProperties(EnvironmentProperties):
    ...
    def concernAssociations(self):
        return self.theConcernAssociations

    def policy(self):
        return self.thePolicy
    ...
    def setFitCriterion(self, v):
        self.theFitCriterion = v
