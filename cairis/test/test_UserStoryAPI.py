...
class UserStoryAPITests(CairisDaemonTestCase):
    ...
    def setUp(self):
        ...
        self.new_us_dict = {"session_id": "test", "object": self.new_us}
    ...
    def test_post(self):
        ...
        rv = self.app.post(
            ...
            data=jsonpickle.encode(self.new_us_dict),
        )
        if sys.version_info > (3,):
            responseData = rv.data.decode("utf-8")
        else:
    ...
    def test_delete(self):
        ...
        url = "/api/userstories/name/%s?session_id=test" % quote(
            self.new_us_dict["object"].theName
        )
