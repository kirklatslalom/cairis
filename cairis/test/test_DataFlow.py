...
class DataFlowTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for iObstacle in d["obstacles"]:
            ...
            iop = ObstacleParameters(
                iObstacle["theName"], iObstacle["theOriginator"], [], [ioep]
            )
    ...
    def testAddDataFlow(self):
        ...
        idfp = DataFlowParameters(
            ...
            self.dfJson["theFromName"],
            self.dfJson["theFromType"],
            self.dfJson["theToName"],
            self.dfJson["theToType"],
    ...
    def testImportDataflows(self):
        self.assertEqual(
            ...
            "Imported 1 dataflow. Imported 0 trust boundaries.",
        )

    def testImportDataflowsWithoutTypee(self):
        self.assertEqual(
            importDataflowsFile(
                os.environ["CAIRIS_SRC"] + "/test/testdataflow_withouttype.xml"
            ),
            "Imported 1 dataflow. Imported 0 trust boundaries.",
        )
        b = Borg()
