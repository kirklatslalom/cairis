...
class PolicyStatementTest(unittest.TestCase):
    def setUp(self):
        ...
        igp1 = GoalParameters(
            self.iGoals[0]["theName"], self.iGoals[0]["theOriginator"], [], [igep1d]
        )
    ...
    def testPolicyStatement(self):
        ...
        ip = PolicyStatement(
            -1,
            self.iPs[0]["theGoalName"],
            self.iPs[0]["theEnvironmentName"],
            self.iPs[0]["theSubject"],
            self.iPs[0]["theAccessType"],
            self.iPs[0]["theResource"],
            self.iPs[0]["thePermission"],
        )
