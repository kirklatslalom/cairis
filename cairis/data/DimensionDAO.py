    ...
    def get_objects_by_names(self, table, id):
        try:
            permissableDimensions = [
                ...
                "misusability_case",
                "misusecase",
                "misusecase_reference",
                "motivation",
                "noncomposite_environment",
                "obstacle",
                "obstacle_category_type",
                "obstacle_reference",
                "persona",
                "persona_characteristic",
                "persona_characteristic_synopsis",
                "persona_implied_process",
                "persona_reference",
                "persona_type",
                "priority_type",
                "privilege",
            ...
            if (
                table == "persona_characteristic_synopsis"
        ...
        try:
            ...
            if table not in permissableDimensions:
                raise CairisHTTPError(
                    ...
                    "Invalid dimension",
                    table
                    + " is not a permissable dimension when specifying environment",
                )
            if self.db_proxy.nameExists(environment, "environment") == False:
                raise CairisHTTPError(
                    NOT_FOUND, "Unknown environment", environment + " does not exist"
                )
