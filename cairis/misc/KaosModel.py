            ...
            if (associationType == "obstruct") or (associationType == "resolve"):
                ...
                if (subGoalName, refNodeName) not in edgeSet:
                    ...
                    if refNodeName not in refNodes:
                        if subGoalDimName in ["task", "usecase"]:
                        ...
                        elif (subGoalDimName == "countermeasure") and (
                            associationType == "and"
                        ):
                            self.theGraph.add_node(
                                pydot.Node(
                        ...
                        elif (associationType == "conflict") or (
                            associationType == "obstruct"
                        ):
                            b = Borg()
                            self.theGraph.add_node(
                                pydot.Node(
                                    refNodeName,
                                    shapefile=conflictFile,
                                    margin=0,
                                    label="",
                                    height=".1",
                                    width=".1",
                            ...
                            assocDirection = "none"
                            arrowHead = "none"
                        elif (goalDimName == "requirement") and (
                            subGoalDimName == "usecase"
                        ):
                            self.theGraph.add_node(
                                pydot.Node(
                                    refNodeName,
