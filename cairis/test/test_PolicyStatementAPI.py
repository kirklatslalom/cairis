...
class PolicyStatementAPITests(CairisDaemonTestCase):
    ...
    def setUpClass(cls):
        importModelFile(
            os.environ["CAIRIS_SRC"] + "/test/PolicyStatementTest.xml", 1, "test"
        )
    ...
    def test_get_by_name(self):
        ...
        url = (
            "/api/policy_statements/goal/"
            + self.existing_goal_name
            + "/environment/"
            + self.existing_environment_name
            + "/subject/"
            + self.existing_subject
            + "/access_type/"
            + self.existing_access_type
            + "/resource/"
    ...
    def test_post(self):
        ...
        self.assertEqual(
            json_resp["message"],
            "Active Directory Network Services/Day/Corporate Network/write/Telemetry Network created",
        )
        rv = self.app.delete(
            "/api/policy_statements/goal/Active%20Directory%20Network%20Services/environment/Day/subject/Corporate%20Network/access_type/write/resource/Telemetry%20Network?session_id=test"
        )
    ...
    def test_put(self):
        ...
        self.assertEqual(
            json_resp["message"],
            "Active Directory Network Services/Day/Corporate Network/write/Telemetry Network updated",
        )
        ...
        self.assertEqual(
            json_resp["message"],
            "Active Directory Network Services/Day/Corporate Network/write/Telemetry Network deleted",
        )
