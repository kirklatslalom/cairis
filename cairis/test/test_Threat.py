    ...
    def setUp(self):
        ...
        iatkeps = [
            ...
            AttackerEnvironmentProperties(
                ...
                iAttackers[0]["theEnvironmentProperties"][1]["theCapabilities"],
            ),
        ]
    ...
    def testThreat(self):
        iteps = [
            ThreatEnvironmentProperties(
                ...
                self.iThreats[0]["theEnvironmentProperties"][0]["theLikelihood"],
                self.iThreats[0]["theEnvironmentProperties"][0]["theAssets"],
                self.iThreats[0]["theEnvironmentProperties"][0]["theAttackers"],
                self.iThreats[0]["theEnvironmentProperties"][0]["theProperties"][0][1],
                self.iThreats[0]["theEnvironmentProperties"][0]["theProperties"][0][1],
            ),
            ThreatEnvironmentProperties(
                self.iThreats[0]["theEnvironmentProperties"][1]["theName"],
                self.iThreats[0]["theEnvironmentProperties"][1]["theLikelihood"],
                self.iThreats[0]["theEnvironmentProperties"][1]["theAssets"],
                self.iThreats[0]["theEnvironmentProperties"][1]["theAttackers"],
                self.iThreats[0]["theEnvironmentProperties"][1]["theProperties"][0][1],
                self.iThreats[0]["theEnvironmentProperties"][1]["theProperties"][0][1],
            ),
        ]
        itps = ThreatParameters(
            self.iThreats[0]["theName"],
        ...
        self.assertEqual(
            [["Integrity", "Medium", "None"]], o.propertyList("", "Maximise", "")
        )
        self.assertEqual(
            [["Integrity", "Medium", "None"]], o.propertyList("", "Override", "Day")
        )
