...
def deserialize_misuse(dict):
    ...
    return MisuseCaseParameters(
        scName=dict["theName"], cProps=mc_props, risk=dict["theRisk"]
    )
...
def deserialize_risk(dict):
    ...
    return RiskParameters(
        riskName=dict["theRiskName"],
        threatName=dict["theThreatName"],
        vulName=dict["theVulnerabilityName"],
        rTags=dict["theTags"],
        mc=mc_obj,
    )
