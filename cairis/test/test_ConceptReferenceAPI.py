...
class ConceptReferenceAPITests(CairisDaemonTestCase):
    ...
    def setUp(self):
        ...
        self.new_cr_dict = {"session_id": "test", "object": self.new_cr}
    ...
    def test_get_by_name(self):
        ...
        url = "/api/concept_references/name/%s?session_id=test" % quote(
            self.existing_cr_name
        )
        rv = self.app.get(url)
    ...
    def test_post(self):
        ...
        rv = self.app.post(
            ...
            data=jsonpickle.encode(self.new_cr_dict),
        )
        if sys.version_info > (3,):
            responseData = rv.data.decode("utf-8")
        else:
