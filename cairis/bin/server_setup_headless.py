...
def main(args=None):
    parser = argparse.ArgumentParser(
        description="CAIRIS server setup script - headless"
    )
    parser.add_argument(
        "--dbHost", dest="dbHost", help="Database host name", default="localhost"
    )
    parser.add_argument(
        "--dbPort", dest="dbPort", help="Database port number", default="3306"
    )
    parser.add_argument(
        "--dbRootPassword",
        dest="dbRootPassword",
    ...
    parser.add_argument(
        "--tmpDir", dest="tmpDir", help="Temp directory", default="/tmp"
    )
    ...
    parser.add_argument(
        "--logLevel", dest="logLevel", help="Log level", default="warning"
    )
    parser.add_argument(
        "--staticDir",
        dest="staticDir",
    ...
    parser.add_argument(
        "--mailServer", dest="mailServer", help="Mail server", default=""
    )
    ...
    parser.add_argument(
        "--mailPasswd", dest="mailPasswd", help="Mail password", default=""
    )
