...
class Response:
    ...
    def properties(self):
        return self.theMitigatedProperties

    def detectionPoint(self):
        return self.theDetectionPoint

    def detectionMechanism(self):
        return self.theDetectionMechanism

    def targets(self):
        return self.theTargets

    def effectiveness(self):
        if self.theMitigatedProperties == array((0, 0, 0, 0, 0, 0, 0, 0)):
            return "None"
        elif self.theMitigatedProperties == array((1, 1, 1, 1, 1, 1, 1, 1)):
            return "Low"
        elif self.theMitigatedProperties == array((2, 2, 2, 2, 2, 2, 2, 2)):
            return "Medium"
        elif self.theMitigatedProperties == array((3, 3, 3, 3, 3, 3, 3, 3)):
            return "High"
