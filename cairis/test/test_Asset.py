...
class AssetTest(unittest.TestCase):
    def setUp(self):
        ...
        self.iep1 = EnvironmentParameters(
            ienvs[0]["theName"], ienvs[0]["theShortCode"], ienvs[0]["theDescription"]
        )
        self.iep2 = EnvironmentParameters(
            ienvs[1]["theName"], ienvs[1]["theShortCode"], ienvs[1]["theDescription"]
        )
        self.iep3 = EnvironmentParameters(
            ienvs[2]["theName"], ienvs[2]["theShortCode"], ienvs[2]["theDescription"]
        )
        b = Borg()
    ...
    def testAsset(self):
        ...
        self.assertEqual(
            [["Confidentiality", "High", "None"], ["Availability", "Medium", "None"]],
