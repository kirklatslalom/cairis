...
class ResponseTest(unittest.TestCase):
    ...
    def testResponse(self):
        ...
        iar1 = ResponseParameters(
            iar1Name,
            self.iResponses[0]["theRisk"],
            [],
            [iaep1],
            self.iResponses[0]["theType"],
        )
        ...
        self.assertEqual(
            iar1.environmentProperties()[0].cost(),
            self.oar1.environmentProperties()[0].cost(),
        )
        self.assertEqual(
            iar1.environmentProperties()[0].description(),
