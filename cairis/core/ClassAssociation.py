...
class ClassAssociation(ObjectValidator.ObjectValidator):
    ...
    def headAsset(self):
        return self.theHeadAsset

    def headDimension(self):
        return self.theHeadDim

    def headNavigation(self):
        return self.theHeadNavigation

    def headType(self):
        return self.theHeadType

    def headMultiplicity(self):
        return self.theHeadMultiplicity

    def headRole(self):
        return self.theHeadRole

    def tailRole(self):
        return self.theTailRole

    def tailMultiplicity(self):
        return self.theTailMultiplicity

    def tailType(self):
        return self.theTailType

    def tailNavigation(self):
        return self.theTailNavigation

    def tailDimension(self):
        return self.theTailDim

    def tailAsset(self):
        return self.theTailAsset
