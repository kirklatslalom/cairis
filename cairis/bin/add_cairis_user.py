...
def addAdditionalUserData(userName, passWd):
    ...
    createDatabaseAndPrivileges(
        b.rPasswd, b.dbHost, b.dbPort, userName, rp, dbAccount + "_default"
    )
    createDatabaseSchema(
        b.cairisRoot, b.dbHost, b.dbPort, userName, rp, dbAccount + "_default"
    )
    createDefaults(
        b.cairisRoot, b.dbHost, b.dbPort, userName, rp, dbAccount + "_default"
    )
...
def main():
    parser = argparse.ArgumentParser(
        description="Computer Aided Integration of Requirements and Information Security - Add CAIRIS user"
    )
